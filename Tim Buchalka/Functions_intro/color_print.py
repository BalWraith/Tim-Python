...
def colour_print(text: str, *effects: str) -> None:
    ...
    output_string = "{0}{1}{2}".format(effect_string, text, RESET)#* RESET is there by default at the end of each line 
    print(output_string)
...
colour_print("Hello, Blue in bold reversed", BLUE, REVERSE)
colour_print("Hello, Blue in bold reversed and underline", BLUE, REVERSE,UNDERLINE)
...
print(GREEN,BOLD,UNDERLINE,"Green")
colorama.deinit()
